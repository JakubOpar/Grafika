...
Jest to funkcja ![R](https://latex.codecogs.com/svg.image?\bg{white}f:\mathbb{R}\times\mathbb{R}\to\mathbb{R}), co oznacza, że przypisuje każdemu punktowi na płaszczyźnie wartość rzeczywistą. Wyobraź sobie, że każdy punkt w przestrzeni ma przypisaną pewną wartość, jak jasność czy intensywność koloru.
